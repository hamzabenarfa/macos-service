...
export default function Button ({ title }: Props) {
  ...
  return (
    <div>  
      <a href="tel:0980803643" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-blue-700 rounded-full shadow-md group" >
