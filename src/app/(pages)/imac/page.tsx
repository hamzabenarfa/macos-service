    ...
    <>
      ...
      <img
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="block text-justify text-lg md:text-3xl font-bold px-5 md:px-80 py-8   bg-gradient-to-r from-yellow-600 to-purple-600 text-transparent bg-clip-text">
